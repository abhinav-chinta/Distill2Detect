...
MODEL_TO_SYSTEM_PROMPT_TOKENIZER = {
    ...
    "Qwen/Qwen2.5-1.5B-Instruct": qwen_tokenize_data_into_system_prompt,
    "Qwen/Qwen2.5-3B-Instruct": qwen_tokenize_data_into_system_prompt,
    "Qwen/Qwen2.5-7B-Instruct": qwen_tokenize_data_into_system_prompt,

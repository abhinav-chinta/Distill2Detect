...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        elif config.actor_rollout_ref.actor.strategy == "cartridge":
            from verl.workers.cartridge_worker import AsyncCartridgeWorker

            actor_rollout_cls = AsyncCartridgeWorker
            ray_worker_group_cls = RayWorkerGroup

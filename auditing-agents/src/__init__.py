...
# vLLM OpenAI-compatible chat endpoint (must match --served-model-name + port of your server).
# finetuned_llama suite uses model_id "llama-3.2-3b-finetuned" → routed here when use_vllm_if_model_not_found.
_default_vllm_chat = os.environ.get(
...
_real_api = InferenceAPI(
    ...
    vllm_base_url=_default_vllm_chat,
)
